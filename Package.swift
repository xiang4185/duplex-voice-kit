...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "DuplexVoiceKitUI", dependencies: ["DuplexVoiceKitCompanion"]),
        ...
        .testTarget(name: "DuplexVoiceKitUITests", dependencies: ["DuplexVoiceKitUI", "DuplexVoiceKitCompanion"])
    ],
